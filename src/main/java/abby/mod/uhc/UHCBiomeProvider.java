...
public class UHCBiomeProvider extends BiomeProvider {
	public static void registerBiomeProvider() {
		Registry.register(Registry.BIOME_PROVIDER_CODEC, new ResourceLocation("abbyuhc", "biome_source"),
				UHCBiomeProvider.CODEC);
	}

	public static final Codec<UHCBiomeProvider> CODEC = RecordCodecBuilder.create((builder) -> {
	...
	private static final List<RegistryKey<Biome>> biomes = ImmutableList.of(Biomes.OCEAN, Biomes.PLAINS, Biomes.DESERT,
	...
	public UHCBiomeProvider(long seed, boolean legacyBiomes, boolean largeBiomes, Registry<Biome> lookupRegistry) {
		...
		this.genBiomes = UHCLayerUtil.func_237215_a_(seed, legacyBiomes, largeBiomes ? 6 : 4, 4);
		LogManager.getLogger().fatal("UHC WORLD GEN");
	}
